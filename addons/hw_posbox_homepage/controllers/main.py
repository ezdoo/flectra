...
""" + index_style + """
    ...
    <body>
        ...
        Sale, <b>version 8.0 or later</b>. You can start an <a href='https://www.flectrahq.com/start'>online free trial</a>,
        or <a href='https://www.flectrahq.com/page/download'>download and install</a> it yourself.
        </p>
        <p>
        For more information on how to setup the Point of Sale with
        the PosBox, please refer to
        <a href='https://www.flectrahq.com/documentation/user/point_of_sale/posbox/index.html'>the manual</a>.
        </p>
        <p>
        ...
        <p>For any other question, please contact the Flectra support at <a href='http://www.flectrahq.com/help'>www.flectrahq.com/help</a>
        </p>
    </body>
</html>
...
<p>
    ...
    You can find the latest images on the <a href="http://nightly.flectrahq.com/master/posbox/">Flectra Nightly builds</a> website.
